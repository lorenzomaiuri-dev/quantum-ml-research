...
class InputDataset:
    def __init__(self, config, file_path_or_repo, dictionary_path=None):
        ...
        self.tokenizer = self._setup_tokenizer(config, dictionary_path, file_path_or_repo)
    ...
    def _setup_tokenizer(self, config, dict_path, data_sample):
        ...
        tokenizers_map = {"CharTokenizer": CharTokenizer, "BiCharTokenizer": BiCharTokenizer}
