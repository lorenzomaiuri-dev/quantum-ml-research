...
\usepackage[italian, nameinlink, capitalise]{cleveref}
...
% ===========================================================================
%  AMBIENTI PER LA REGOLA REDAZIONALE
%
%  La regola del README impone che resti distinguibile cosa è definizione
%  teorica, cosa comportamento implementato, cosa dato osservato e cosa
%  interpretazione. La distinzione è resa nel testo in forma lessicale; gli
%  ambienti sotto sono riservati ai casi in cui deve saltare all'occhio.
%
%  Uso: `definizione` e `ipotesi` sono numerati e citabili, quindi si usano
%  liberamente. `limite` marca le limitazioni che circoscrivono le conclusioni
%  ed è l'unico ambiente non numerato ancora in uso corrente.
%  `implementazione`, `osservazione` e `interpretazione` restano definiti per
%  compatibilità, ma il testo li rende in prosa: non introdurne di nuovi senza
%  motivo, perché la loro accumulazione spezza la leggibilità del capitolo.
% ===========================================================================
...
\newcommand{\rifiutata}{\textbf{rifiutata}}
\newcommand{\nonrifiutata}{\textbf{non rifiutata}}
\newcommand{\rifiutataopposta}{\textbf{rifiutata in direzione opposta}}
