...
Le tabelle riproducono i campi dei \file{config.json} associati alle run
analizzate, incluse le proprietà calcolate (\cref{sec:base-config}).
...
\code{big} non è utilizzabile nella variante quantistica perché la simulazione
di 64 qubit eccede le risorse disponibili.}
...
La run definitiva usa il preset \code{thesis}, riportato per esteso qui
