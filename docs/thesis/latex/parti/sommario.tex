...
\Coautore{}: la parte relativa al calcolo quantistico e ai suoi fondamenti fisici
è stata sviluppata principalmente da lui, mentre l'architettura del software,
l'organizzazione del repository e la trattazione dei Transformer sono seguite
principalmente da chi scrive; l'implementazione del codice e le restanti attività
sono condivise.
