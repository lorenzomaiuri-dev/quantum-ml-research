% ===========================================================================
%  Sommario / Abstract
%  Regola: il sommario contiene già l'esito, non la sola promessa.
% ===========================================================================
\chapter*{Sommario}
...
Questa tesi verifica sperimentalmente i tre benefici che non richiedono hardware
...
direzione attesa e criterio di falsificazione dichiarati a priori, e verificate
...
più capiente del blocco quantistico; adotta inoltre un disegno multi-seed e
...
negativo. Nell'ablazione il gap quantistico meno controllo limitato è positivo
su tutti i dataset ($+0{,}148$, $+0{,}100$, $+0{,}085$), mentre il kernel IQP ha
...
\code{quantum\_framework}, una libreria che rende ripetibile il confronto
quantistico/classico appaiato, layer variazionali, caricamento dati, ciclo di
addestramento con diagnostica su gradienti e saturazione, metriche, test
statistici e manifest di provenienza e un protocollo sperimentale documentato
che consente a terzi di replicare o confutare ogni affermazione qui riportata.
