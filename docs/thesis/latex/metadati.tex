...
\newcommand{\TitoloTesi}{%
  Componenti quantistici nei transformers: uno studio sistematico su simulatori quantistici}
\newcommand{\SottotitoloTesi}{%
  Quattro esperimenti appaiati su espressività, regolarizzazione implicita
  e separabilità}
